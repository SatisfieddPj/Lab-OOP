 ...
 */
public class Main {
/*    public static void main(String[] args) { //Student 3.
        Student s = new Student();
        s.mScore = 80;
        s.fScore = 80;
        s.showGrade();
    }*/
/*    public static void main(String[] args) { //Fraction 4.
...
/*    public static void main(String[] args) { //Fraction 5.
        Fraction f1 = new Fraction();
        f1.topN = 1;
        f1.btmN = 3;
...
/*    public static void main(String[] args) { //Book 6.
        Book book1 = new Book();
...
/*    public static void main(String[] args) { //Customer 7.
